...
In this article we overview each scPipeline, and provide details on how to specify parameters for analysis. 

Our convention is to stored all analysis parameters in a list named `parameter.list` at the start of the script:
...
- Ochocka 2021: [immune infiltrates in GL261-engrafted murine brain](articles/R643_M01_Ochoka2021_QC_NM2_21_Sep_3_39_09_PM_2021.html)       
...
## Module 05: Cell-Type Annotation
...
## Module 09: Gene Expression and Associations
...
## Module 18: Cluster Optimization
...
## Module 37: Gene Module Detection

### Description

Gene module or meta-gene identification. Three independent methods are used in an ensemble approach to perform gene network analysis and identify gene module of interest:

- Scale-free shared nearest neighbor network analysis (SSN)
- Independent component analysis (ICA)
- Non-negative matrix factorization (NMF)

Gene set enrichement is performed on each module to facilitate functional annotation. 
...
#### Analysis Parameters
 ...
 <!-- expr, hvg, deviance (Default is expr) -->
