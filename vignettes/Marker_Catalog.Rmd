...
# show table
flex.asDT(cell_catalog, page_length = 15,  scrollX = TRUE)
```
...
```{r}
# show cell-types
flex.asDT(data.frame(cell_types = names(cell_catalog.list)), page_length = 15)
```


## Single cell atlases {.tabset}
...
knitr::include_graphics("assets/atlas_cao2020.png")
...
knitr::include_graphics("assets/atlas_mannos2021.png")
...
knitr::include_graphics("assets/atlas_ps2019.png")
...
knitr::include_graphics("assets/atlas_tm.png")
...
knitr::include_graphics("assets/atlas_ts.png")
...
knitr::include_graphics("assets/atlas_tyser2021.png")
...
knitr::include_graphics("assets/atlas_zeisel2018.png")

```

## Other cell-type databases {.tabset}
...
# show table
flex.asDT(human_markers, page_length = 15,  scrollX = TRUE)
```
...
# show table
flex.asDT(cell_markers, page_length = 15,  scrollX = TRUE)
```
